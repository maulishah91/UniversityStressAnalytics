...
class MLPDropout(object):
    def __init__(self, rng, input, layer_sizes, dropout_rates, activations, use_bias=True, W=None, b=None):
        ...
        self.dropout_output_layer = LogisticRegression(
                ...
                n_in=n_in, n_out=n_out, W=W, b=b, shared_var=False)
...
class LogisticRegression(object):
    def __init__(self, input, n_in, n_out, W=None, b=None, shared_var=True):
        ...
        if W is None:
            self.W = theano.shared(
                    ...
                    name='W')
        elif shared_var is True:
            self.W = W
        else:
            self.W = theano.shared(W,borrow=True,name='W')
        ...
        if b is None:
            ...
            self.b = theano.shared(b, borrow=True, name='b')
